...
def add_images(im_data, h5_file, args):
    ...
    for i, img in enumerate(im_data):
        ...
        basename_ = img['url'].split('/')
        basename = '/'.join(basename_[-2:])
        if '{}.jpg'.format(img['image_id']) in corrupted_ims:
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', default='/data/scene_understanding/Visual_Genome/')
