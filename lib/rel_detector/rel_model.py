...
from lib.model.pytorch_misc import transpose_packed_sequence_inds, to_onehot, arange, enumerate_by_image, diagonal_inds, Flattener
...
class LinearizedContext(nn.Module):
    ...
    def __init__(self, classes, rel_classes, mode='sgdet',
        ...
        if self.nl_edge > 0:
            ...
            self.edge_ctx_rnn = nn.LSTM(input_size=input_dim,
                                                       hidden_size=self.hidden_dim,
...
class RelModel(nn.Module):
    ...
    def forward(self, x, im_sizes, image_offset,
        ...
        """
        result = self.detector(x, im_sizes, image_offset, gt_boxes, gt_classes, gt_rels,
