...
from lib.model.draw_rectangles.draw_rectangles import draw_union_boxes
import numpy as np

from torch import nn
from config import BATCHNORM_MOMENTUM

class UnionBoxesAndFeats(nn.Module):
...
def union_boxes(fmap, rois, union_inds, pooling_size=14, stride=16):
    ...
    union_pools = ROIAlign((pooling_size, pooling_size),1/stride, 0)(fmap, union_rois)
    return union_pools
